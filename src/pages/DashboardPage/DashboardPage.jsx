...
import {getAllDashboardSelector} from '../../redux/selectors';
				...
				<Container maxWidth="xl">
					<Stack spacing={1}>
						...
						<div style={{display: 'flex', justifyContent: 'flex-end'}}>
							<FormControl sx={{minWidth: 120, mr: 2, mb: 'auto', mt: 'auto'}}>
								<Select
													...
													<OverviewSummary
														label={
															selectedTable === 'bookings'
																? 'Total Bookings'
																: selectedTable === 'incomes'
																	? 'Total Incomes'
																	: selectedTable === 'revenues'
																		? 'Total Revenue'
																		: ''
														}
														value={
															selectedTable === 'bookings'
																? `${data.bookings.bookings.total_booking.toString()}`
																: selectedTable === 'incomes'
																	? `${data.bookings.incomes.total_income.toString()}`
																	: selectedTable === 'revenues'
																		? `${data.bookings.revenues.total_revenue.toString()}`
																		: ''
														}
													/>
												</Grid>
