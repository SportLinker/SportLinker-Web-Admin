...
const dataSource = [
    ...
    },
    {
        ...
        content: 'Discover the must-have gear for runners to enhance performance and prevent injuries.',
    ...
    },
    {
        ...
        content: 'Improve flexibility and prevent injuries with this yoga routine designed for athletes.',
    ...
    },
    {
        ...
        content: 'Stay injury-free on the road with these essential injury prevention tips for cyclists.',
    ...
    },
    {
        ...
        content: 'Stay updated on upcoming running events in your area with this comprehensive calendar.',
    ...
    },
    {
        ...
        content: 'Boost your energy and recovery with these delicious and nutritious smoothie recipes.',
        ...
        <div className={styles.postContainer}>
            ...
            <div>
                <Table dataSource={dataSource} rowKey="key" pagination={{ pageSize: 5 }}>
                    ...
                    <Column title="Img Url" dataIndex="imgUrl" key="imgUrl" />
                    ...
                    <Column
                        ...
                        key="status"
                        render={(status) => (
                            <Tag color={status === 'Success' ? 'green' : status === 'Fail' ? 'red' : 'orange'}>
                                {status}
                            </Tag>
                        )}
                    />
                    <Column
                        ...
                        render={(text, record) => (
                            <span>
                                ...
                                <Button type="danger" style={{ backgroundColor: '#ff0000', color: 'white' }}>
