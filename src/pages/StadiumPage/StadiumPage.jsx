...
export const StadiumPage = () => {
	...
	const handleUpdateStatus = async () => {
		if (selectedStadium && statusToUpdate) {
			try {
				await dispatch(
					updateStadiumStatus({stadiumId: selectedStadium.id, status: statusToUpdate})
				);
			...
			<div className={styles.stadiumContainer}>
				...
				<div>
					...
					>
						...
						<Column
							title="Description"
							dataIndex="stadium_description"
							key="stadium_description"
						/>
						<Column
							title="Operating Hours"
							dataIndex="stadium_time"
							key="stadium_time"
						/>
						<Column
							title="Status"
						...
						{selectedStadium && (
							<div>
								...
								<p>
									...
									{selectedStadium.stadium_description}
								</p>
								<p>
